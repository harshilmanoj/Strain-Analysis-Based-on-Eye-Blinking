...
while True:
    ...
    for rect in rects:
        ...
        if TOTAL < blinks - eye_thresh:
            playaudio("Take rest for a while as your blink count is less than the average count")
            ...
            playaudio("Take rest for a while as your blink count is more than the average count")
            popupmsg("Take rest for a while!!!! :D")
            cv2.putText(frame, "Take rest for a while!!!! :D", (70, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
